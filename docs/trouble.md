...
!!! tip "硬件损坏的可能性极小，99%的问题都可以通过[刷写完整固件修复](upgrade2.md#CMSIS-DAP烧录工具更新)"
...
3. 如果第一步中指示灯无指示，但是第二步中判断出USB芯片没有问题：
    ...
    -  如果指示灯还是无任何指示，可以尝试刷写`完整蓝牙固件`修复键盘 [查看CMSIS-DAP包刷写完整蓝牙固件？](upgrade2.md#CMSIS-DAP烧录工具更新)
    -  如果刷写`完整蓝牙固件`时找不到键盘，可能是蓝牙主控或USB主控已经损坏（硬件损坏的可能性极小）。
4. 如第二步中判断出USB芯片存在问题：
