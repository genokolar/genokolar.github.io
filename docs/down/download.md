...
| 下载内容   | 说明  | 下载地址 |
| :------------:|  ------------| :------------: |
| <b> 键盘主控完整固件</b> <br>（nRF52系列芯片）|  <b>2023.03.03更新：优化键盘2.4G配对流程，优化2.4G跳频算法</b> <br>此固件基于nRF SDK17.1 <br> 完整固件可在SDK之间切换 <br> 刷写包包含所有键盘完整固件，可直接升级或修复键盘 | <a href="https://down.glab.online:5550/Glab3.1/" class="button">📦官网下载页</a> <br> <a href="https://github.com/genokolar/nrf52-keyboard/releases" class="button">🧱Github发布页</a><br><a href="https://eyun.baidu.com/s/3jKqTC7k" class="button">🗂️百度网盘存档</a>|
