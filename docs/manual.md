...
!!! tip "本页面最后修改时间2025-06-09"
    - 本页面操作说明全系列键盘通用，所有内容基于最新版固件，如与当前键盘实际不符，建议升级固件
    - 更多键盘专有说明可以访问键盘[产品信息](keyboard/volta9.md)页面
...
USB连接状态下，可通过<kbd>Lshift</kbd>+<kbd>Rshift</kbd>+<kbd>Q</kbd>/<kbd>W</kbd>/<kbd>E</kbd>直接跳转到对应蓝牙或2.4G通道。
...
???+ tip "特别提示"
    ...
    - 新版固件也支持通过[键盘控制面板](/control/)控制各种系统功能
