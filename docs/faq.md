...
3. 烧录工具，可通过USB线连接键盘，刷入`USB固件`和`蓝牙固件`。
...
我们当前主要采用了nRF52810/nRF52811/nRF52832三种型号的蓝牙主控

三者的主要区别：

-  基本功能上没有区别，体验没有啥区别。
-  nRF52832支持DFU升级，nRF52810/nRF52811不支持DFU升级
-  nRF52810/nRF52811性能相同，弱于nRF52832，但不会有体验差别
-  nRF52832拥有更高的性能，硬件资源更丰富，有更好的后续扩展性
