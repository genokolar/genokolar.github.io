...
1. 下载运行 [按键检测软件](https://down.glab.online:5550/keyboardtestutility.exe)  或 访问[🌍按键检测网站](keytest/index.html) 。
...
或将键盘接入[键盘控制面板](/control/)，可获取键盘硬件版本、固件编译日期、固件版本、电量、芯片型号等信息。
...
2. 从PCB颜色判断，绿色PCB只有极少数支持,PCB为黑色/白色等其他颜色的均支持
